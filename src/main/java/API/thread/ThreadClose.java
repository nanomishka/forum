 ...
 */
public class ThreadClose extends HttpServlet {
    private Connection myConn;
    public ThreadClose(Connection myConnect) { myConn = myConnect; }

    public void doPost(HttpServletRequest request,
                       HttpServletResponse response) throws ServletException, IOException {
        System.out.println("Query: Thread close");
        ...
        try{
            ...
            myStmt.close();
            myStmt = myConn.prepareStatement("UPDATE threads SET isClosed = true WHERE id = ?");
            myStmt.setString(1, jsonData.getString("thread"));
