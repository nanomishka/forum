 ...
 */
public class ThreadOpen extends HttpServlet {
    private Connection myConn;
    public ThreadOpen(Connection myConnect) { myConn = myConnect; }

    public void doPost(HttpServletRequest request,
                       HttpServletResponse response) throws ServletException, IOException {
        System.out.println("Query: Thread open");
        ...
        try{
            ...
            myStmt.close();
            myStmt = myConn.prepareStatement("UPDATE threads SET isClosed = false WHERE id = ?");
            myStmt.setString(1, jsonData.getString("thread"));
