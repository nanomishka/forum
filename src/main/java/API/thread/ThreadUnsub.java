 ...
 */
public class ThreadUnsub extends HttpServlet {
    private Connection myConn;
    public ThreadUnsub(Connection myConnect) { myConn = myConnect; }

    public void doPost(HttpServletRequest request,
                       HttpServletResponse response) throws ServletException, IOException {
        System.out.println("Query: Thread unsubscribe");
        ...
        try {
            ...
            if (user.equals("") || thread.equals("")) {
                ...
                myStmt.close();
                myStmt = myConn.prepareStatement("DELETE FROM subscribes WHERE user = ? and thread = ?");
